...
function ServicePaymentHashPay() {
  ...
  // HashBack API Configuration (same as PaymentPage2)
  const HASHBACK_API_URL = 'https://hash-back-server-production.up.railway.app';
  
  // Direct HashPay API Configuration
  ...
  const setupWebSocket = () => {
    try {
      ...
      wsRef.current.onopen = () => {
        console.log('WebSocket connected for service payment');
      ...
      html: `
        <div style="text-align: center;">
          ...
          <div style="background: #f8f9ff; padding: 12px; border-radius: 8px; margin-top: 15px; text-align: left;">
            <p style="margin: 5px 0;"><strong>Transaction ID:</strong> ${data.transactionId || data.TransactionID || 'N/A'}</p>
  ...
  const handlePayment = async () => {
        ...
        <div style="text-align: center;">
          ...
          <div style="background: #f8f9ff; border-radius: 10px; padding: 14px; margin-bottom: 16px; text-align: left;">
            ...
            <div style="display: flex; justify-content: space-between;">
              ...
              <span style="color: #10b981; font-weight: 600;">${formatPhoneForDisplay(userData.phone)}</span>
            </div>
          </div>
    ...
    const formattedPhone = formatPhoneNumberForHashBack(userData.phone);
                            ...
                            html: `
                              <div style="text-align: center;">
                                ...
                                <p style="margin-top: 15px; font-size: 0.85rem; color: #666;">
                                  You can try checking your results again in a few minutes.
                                </p>
                              </div>
                            `,
                            icon: "info",
...
export default ServicePaymentHashPay;